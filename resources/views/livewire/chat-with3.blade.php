            ...
            <div class="message-box">
                ...
                <div class="peoples-mesg-box">
                    <div class="conversation-head">
                        <figure><img src="{{ asset('frontend/assets/images/resources/friend-avatar.jpg') }}" alt=""></figure>
                    ...
                    <ul class="chatting-area" wire:poll.keep-alive>
                        @forelse ($messages as $message)
                            @if ($message->friend_id == auth()->id())
                                <li class="me">
                                    <figure><img src="{{ asset('frontend/assets/images/resources/userlist-2.jpg') }}" alt=""></figure>
                                    <p>{{ $message->message }}</p>
                                </li>
                            @else
                                <li class="you">
                                    <figure><img src="{{ asset('frontend/assets/images/resources/userlist-1.jpg') }}" alt=""></figure>
                                    <p>{{ $message->message }}</p>
                                </li>
                            @endif
                        @empty
